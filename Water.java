 ...
 *
 *File:
 *	$Id: Water.java,v 1.3 2013/05/03 13:52:11 cas5420 Exp $
 *
 *Revisions
 *	$Log: Water.java,v $
 *	Revision 1.3  2013/05/03 13:52:11  cas5420
 *	Completed chess solver, debugging
 *
 *	Revision 1.2  2013/05/01 11:46:16  cas5420
 *	Updated solver to generics
 *
 *	Revision 1.1  2013/04/27 13:01:01  cas5420
 *	Started project
 *
 *	Revision 1.1  2013/04/14 20:50:52  mgp9795
 *	Part 2 Adjustments
 */
...
public class Water implements Puzzle<ArrayList<Integer>>
{
	 ...
	 * @param args - command line arguments, first is desiredWater, following are jug capacities
	 */
	...
	/**
	 * returns Arraylist of zeros with size equal to the number of jugs
	...
	/**
	 * Used to restore a neighbor configuration to the original state
	 * @param orig - the original state
	 * @return ArrayList<Integer> newConfig
	 */
	 ...
	 * @param args - holds values for private fields
	 */
	public static void main(String[] args)
	{
		...
		if(args.length >= 2)
		{
			...
			//String[] intargs = {"5","3","1", "2"};
			//solution = Solver.solve(new Water(intargs));
			if(solution != null)
			{
